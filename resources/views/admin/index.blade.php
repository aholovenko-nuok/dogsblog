              ...
              <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center"><a class="btn btn-success" href="/admin/places/{{$article->id}}/edit">Редагувати</a></td>
                    <td class="text-center"><a class="btn btn-danger" href="#" data-toggle="modal" data-target="#deleteModal-{{$article->id}}">Видалили</a></td>
                  </tr>
                  <!-- Delete Modal-->
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <form method="POST" action="/admin/places/@if(isset($article->id)){{$article->id}}@endif">
                {{ method_field('DELETE') }}
                {{ csrf_field() }}
                ...
                <div class="control">
                  ...
                  @endforeach()
                  @else
                  <td colspan ="4">Пам'яток у базі данних не знайдено. Оновіть дані</td>
                  @endif
                </tbody>
              </table>
            </div>
